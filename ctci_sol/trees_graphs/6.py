...
"""
find the inoder successor in a BST 
"""
...
# same as a normal binary search tree, except each node can reach its parent node as well.
...
if __name__ == "__main__":
    ...
    #
    print ("enter the value of node of whose inoder successor you wish to findout ")
    val = int(input())
    node = tree.find_inorder_successor(val)
    if node == None:
       print ("the inoder successor of  is : None")
    else:
       print ("the inoder successor of  is : ",node.value)
